...
local Window = OrionLib:MakeWindow({Name = "SrciptLuaVip", HidePremium = false, IntroText = "SrciptLuaVip", SaveConfig = true, ConfigFolder = "SrciptLuaVip"})
...
M:AddParagraph("Kaitun/Cantay","Kaitun bản này ko khác gì bản kia.")
