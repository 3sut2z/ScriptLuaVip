...
UICorner_4.Parent = Get Key

UIAspectRatioConstraint_4.Parent = Get Key
UIAspectRatioConstraint_4.AspectRatio = 2.553

verifyKey.Name = "Check Key"
...
verifyKey.Text = "Check Key"
verifyKey.TextColor3 = Color3.fromRGB(255, 255, 255)
verifyKey.TextSize = 20.000

UICorner_5.Parent = Check Key

UIAspectRatioConstraint_5.Parent = Check Key
...
local AkaliNotif = loadstring(game:HttpGet("https://raw.githubusercontent.com/3sut2z/ScriptLuaVip/main/ScriptLuaVip_Notify.lua"))();
