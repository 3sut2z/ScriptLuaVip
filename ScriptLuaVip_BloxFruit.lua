...
local Window = OrionLib:MakeWindow({Name = "ScriptLuaVip", HidePremium = false, IntroText = "ScriptLuaVip", SaveConfig = true, ConfigFolder = "ConfigSetting"})
...
M:AddLabel("When Killing a Player, you can turn Kaitun off and then turn it back on for the next Player")   
M:AddLabel("Note!!, because this is a Beta version, you need to kill players manual operation required!!")
